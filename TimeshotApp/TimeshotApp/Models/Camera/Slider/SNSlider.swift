...
public class SNSlider: UIView {
    ...
    private func loadData() {
        ...
        var filter = SNFilter.applyFilterWithScaling(dataSource!.filters(self).last!, image: dataSource!.imageFiltered(self), isFrontCamera: dataSource!.isFrontCamera(self))
        data.append(filter)
        ...
        filter = SNFilter.applyFilterWithScaling(dataSource!.filters(self)[0], image: dataSource!.imageFiltered(self), isFrontCamera: dataSource!.isFrontCamera(self))
        data.append(filter)
